...
const Mainpage = () => {
    return (
        <div className='w-full overflow-hidden h-full px-2 py-5 lg:py-10 lg:px-64 Main-container bg-zinc-100 md:px-20'>
                ...
                <div className='flex gap-3 px-1 py-1 mt-2 lg:px-2 lg:mt-6 lg:gap-12'>
                    {
                        ["Tools", "AWS Builder", "Start Build", "Build Supplies", "Tooling", "BlueHosting"].map((item) => {
                            return <div className='w-auto h-auto px-2 pt-1 text-center bg-white rounded-md lg:py-1'>{item}</div>
                        })
                    }
                </div>
            ...
            <div className='Product-Container'>
                <div className='relative lg:h-[34vh] h-[28vh] lg:mb-2 mb-5 bg-white Product lg:w-[65vw] w-[96vw] rounded-lg lg:mt-5 flex'>
                    <div className='w-1/4 h-full  flex flex-col items-center justify-center py-10'>
                    ...
                    <div className='w-2/3 h-full px-1 py-1 lg:px-4 lg:py-5 lg:text-base text-xs'>
                    ...
                    <div className='w-1/4 h-full px-2 lg:px-4 text-sm  text-center'>
                        <div className='lg:w-32 w-20 py-2 lg:mx-auto rounded-b-lg h-28 bg-blue-50'>
                    ...
                    <span className='absolute w-auto h-auto lg:px-4 lg:py-2 px-3 py-1 text-center bg-white border-[1px] border-zinc-400 rounded-full lg:-left-4 -left-1 top-7'>1</span>
                </div>
                <div className='relative lg:h-[34vh] h-[28vh] mb-2  bg-white Product lg:w-[65vw] w-[96vw] rounded-lg lg:mt-5 flex'>
                    <div className='w-1/4 h-full  flex flex-col items-center justify-center py-10'>
                        <div className='w-24 h-20 px-2 my-14 lg:px-5 text-xs lg:text-base text-center lg:w-44 lg:h-40 lg:my-12'><img className='lg:mb-3' src='https://s3-alpha-sig.figma.com/img/3250/2fc6/187db358671328189d3da83955a6ffe9?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ax2xncFBKe1xE2EsxdvElceh8oIqKj5N0jH4NJTiBcahukOzPxx4h1z6yHWL5iAGwcZziaBWfUhJnOIkYfeTkuKTAQ3cZ0jcc19S7zOzX3YtV8qd2foEnwflcvKEK8-iqw~VegstF5Nw8QROw9i36ihQaXHBsSdmfGb7V~XdDUKn2fabEOEcm2tN9ETF0zbCn6Tq~PYk9pxyghi5P3ugATGWGP8ljAH8tlJzjgbGXnUBNNTS4sfQDZNsmBvFmdtbDb28LeFrh~MRRFxi7hGf1M9mBH8gyb7qPYFk0pRsrwIdNrDPTsn0IaF8FPwAR8zL3wCBUlfMgzxP1E-gqRbjxQ__'></img>
                            <span>Builder 2</span>
                        </div>
                    ...
                    <span className='absolute w-auto h-auto lg:px-4 lg:py-2 px-3 py-1 text-center bg-white border-[1px] border-zinc-400 rounded-full lg:-left-4 -left-1 top-7'>2</span>
                </div>
                <div className='relative lg:h-[34vh] h-[28vh] mb-2  bg-white Product lg:w-[65vw] w-[96vw] rounded-lg lg:mt-5 flex'>
                    <div className='w-1/4 h-full  flex flex-col items-center justify-center py-10'>
                        <div className='w-24 h-20 px-2 my-14 lg:px-5 text-xs lg:text-base text-center lg:w-44 lg:h-40 lg:my-12'><img className='lg:mb-3' src='https://s3-alpha-sig.figma.com/img/3250/2fc6/187db358671328189d3da83955a6ffe9?Expires=1710115200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ax2xncFBKe1xE2EsxdvElceh8oIqKj5N0jH4NJTiBcahukOzPxx4h1z6yHWL5iAGwcZziaBWfUhJnOIkYfeTkuKTAQ3cZ0jcc19S7zOzX3YtV8qd2foEnwflcvKEK8-iqw~VegstF5Nw8QROw9i36ihQaXHBsSdmfGb7V~XdDUKn2fabEOEcm2tN9ETF0zbCn6Tq~PYk9pxyghi5P3ugATGWGP8ljAH8tlJzjgbGXnUBNNTS4sfQDZNsmBvFmdtbDb28LeFrh~MRRFxi7hGf1M9mBH8gyb7qPYFk0pRsrwIdNrDPTsn0IaF8FPwAR8zL3wCBUlfMgzxP1E-gqRbjxQ__'></img>
                    ...
                    <span className='absolute w-auto h-auto lg:px-4 lg:py-2 px-3 py-1 text-center bg-white border-[1px] border-zinc-400 rounded-full lg:-left-4 -left-1 top-7'>3</span>
                </div>
                <div className='relative lg:h-[55vh] h-[38vh]  bg-white Product lg:w-[65vw] w-[96vw] rounded-lg lg:mt-5 flex'>
                    ...
                    <div className='w-2/3 h-full px-1 py-1 lg:px-4 lg:py-5 lg:text-base text-xs'>
                        ...
                        <span className='font-bold'>Main highlights</span>
                        <div className='ml-5 mt-1 lg:mb-4 w-[30vw] lg:h-28 h-22  rounded-lg lg:text-base text-[9px] bg-orange-100 px-1 py-1 lg:py-2 lg:px-5 flex flex-col gap-2 lg:gap-3'>
                            <div>
                        ...
                        <div>
                            ...
                            <div className='flex gap-2'>
                                <span className='lg:w-5 lg:h-5 px-1 py-1 lg:px-[2.5px] lg:py-[2.5px] text-xs lg:text-sm text-blue-800 bg-blue-100 rounded-full'><FaCheck /></span> <span className='text-zinc-600'>Documentation</span>
                            </div>
                            <div className='flex gap-2 my-2'>
                                <span className='lg:w-5 lg:h-5 px-1 py-1 lg:px-[2.5px] lg:py-[2.5px] text-xs lg:text-sm text-blue-800 bg-blue-100 rounded-full'><FaCheck /></span> <span className='text-zinc-600'>Easy Use</span>
                            </div>
                            <div className='flex gap-2'>
                                <span className='lg:w-5 lg:h-5 px-1 py-1 lg:px-[2.5px] lg:py-[2.5px] text-xs lg:text-sm text-blue-800 bg-blue-100 rounded-full'><FaCheck /></span> <span className='text-zinc-600'>Out Of Box</span>
                            </div>
                        </div>
                        <div className='flex items-center gap-1 text-blue-500'><span>Show more</span><IoIosArrowDown /></div>
                    </div>
                    ...
                    <span className='absolute w-auto h-auto lg:px-4 lg:py-2 px-3 py-1 text-center bg-white border-[1px] border-zinc-400 rounded-full lg:-left-4 -left-1 top-7'>4</span>
                </div>
            </div>
        </div>
    )
